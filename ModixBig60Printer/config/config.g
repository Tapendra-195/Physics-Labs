...
M569 P3 S1													; Physical drive 3. Primary Extruder
...
M557 X{move.axes[0].min + sensors.probes[0].offsets[0] + 1, move.axes[0].max + sensors.probes[0].offsets[0] - 1} Y{move.axes[1].min + sensors.probes[0].offsets[1] + 1, move.axes[1].max - sensors.probes[0].offsets[1] - 1} P21:21
;modified by Tapendra Apr 13, 2026. Probe was going outside the bed in the back left and having leveling issue in the back left. This fixes it
...
;Modified by Tapendra. fan0 port is cooked
; Fans & LED_________________________________________________________
M950 F0 C"fan2" Q500										; create fan 0 on pin fan2(fan0 port is cooked, Tapendra) and set its frequency
M106 P0 S0 H-1 C"Primary blower fan"						; set fan 0 value.
M950 F2 C"fan0" Q500										; create LED on pin fan0 and set its frequency. (This is unused because the mosfet on fan0 is probably cooked)
...
if {global.printheads} = 2
	...
	G10 P1 X0.26 Y51.91 Z0										; set tool 1 axis offsets ;Add offset of 4.16 to 49; add 1.27 to x axis
