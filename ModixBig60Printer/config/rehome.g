...
G1 H1 X{(move.axes[0].max+5)*-1} Y{(move.axes[1].max+5)} F6000  ; move quickly to X, Y and Y axis endstops and stop there (first pass)
G1 H2 X2 Y-2 F600      											; go back a few mm
